...
function load_wpcom_block_editor_nux() {
	/**
	 * Can be used to disable Dotcom editor guide.
	 *
	 * @since 0.23
	 *
	 * @param bool true if Dotcom editor nux should be disabled, false otherwise.
	 */
	if ( apply_filters( 'a8c_disable_dotcom_editor_nux', false ) ) {
		return;
	}
